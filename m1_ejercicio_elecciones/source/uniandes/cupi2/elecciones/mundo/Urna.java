...
public class Urna
{
    ...
    public Urna( )
    {
        ...
        candidato2 = new Candidato ("Susanita", "Chirussi", "Revolucionario", 26);
    ...
    {
    	double numVotosintCandidato1;
        double votosTotales;

        double porcentaje;

        numVotosintCandidato1 = candidato1.darVotosInfluenciaInternet( );
        votosTotales = calcularTotalVotos( );

        porcentaje = numVotosintCandidato1 / votosTotales * 100;
    ...
    {
    	double numVotosintCandidato2;
        double votosTotales;

        double porcentaje;

        numVotosintCandidato2 = candidato2.darVotosInfluenciaInternet( );
        votosTotales = calcularTotalVotos( );

        porcentaje = numVotosintCandidato2 / votosTotales * 100;
    ...
    {
    	double numVotosintCandidato3;
        double votosTotales;

        double porcentaje;

        numVotosintCandidato3 = candidato3.darVotosInfluenciaInternet( );
        votosTotales = calcularTotalVotos( );

        porcentaje = numVotosintCandidato3 / votosTotales * 100;
